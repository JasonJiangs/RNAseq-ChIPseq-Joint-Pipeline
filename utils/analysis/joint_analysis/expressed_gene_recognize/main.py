from tools.promoter_detector import range_detector
...
def main(log2FoldChange, summit_file=None, range_file_path=None, promoter_region_path=None,
    ...
    range_detector(10000, 10000, '+')
    range_detector(2000, 2000, '+')
    ...
    promoter_2kb = read_bed_file('result/range/range2000_2000_+.bed')
    promoter_10kb = read_bed_file('result/range/range10000_10000_+.bed')
    print('\n')
    ...
    # promoter
    print('\nPromoter ...')
    promoter_gene_detector(with_up_down_path, promoter_region_path, result_path)
    # enhancer
    print('\nEnhancer ...')
    enhancer_gene_detector(with_up_down_path, enhancer_region_path, result_path)
